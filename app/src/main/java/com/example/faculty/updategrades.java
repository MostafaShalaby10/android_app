...
public class updategrades extends AppCompatActivity {
    ...
    public void updategrades(View view) {
        ...
        {
            boolean result = db.updategrades(idtxt.getText().toString() , grade1txt.getText().toString(), grade2txt.getText().toString(), grade3txt.getText().toString(), grade4txt.getText().toString(), grade5txt.getText().toString(), grade6txt.getText().toString());
